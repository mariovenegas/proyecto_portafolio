...
def insert(request):
    ...
    user = User(rut=rut, dv=dv, name=name, address=address, comune=comune, region=region, type=type, id_client=id_client,username=username,password=password  )
    user.save()
...
def update(request, user_id):
    ...
    user.comune = request.POST.get('comune')
